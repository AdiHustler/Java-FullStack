...
public class FindStudentData {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String ins="INSERT INTO STUDENT VALUES(105,'MICHAEL','michael104@gmail.com','male')"; // Static Query
			...
			System.out.println("Printing all the data from the table");
			while(res.next()) {
				System.out.println(res.getInt("id")+" "+res.getString("st_name")+" "+res.getString("gender"));
			}
